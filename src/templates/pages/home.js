  ...
  <section class="trust-strip">
    <div class="container">
      <div class="trust-grid">
        <div class="trust-item"><span class="num" data-counter data-count-to="4.8" data-suffix="★">0★</span><span class="label">${SITE.reviewCount} ${isEs ? 'reseñas de Google' : 'opinions de Google'}</span></div>
